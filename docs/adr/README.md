...
| [0006](0006-pgvector-cloud-retrieval-storage.md) | pgvector on RDS for cloud vector storage | Proposed pending owner review and retrieval evidence |
...
| Vector engine/index, embedding versions and retrieval limits | Project team and owner, #16 then S7–S9 | [ADR 0006](0006-pgvector-cloud-retrieval-storage.md) proposes pgvector on RDS; confirm product choice and measure exact-search baseline first |
