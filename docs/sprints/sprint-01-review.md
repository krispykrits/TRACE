...
| [#6 Docs/IaC foundations](https://github.com/krispykrits/TRACE/issues/6) | In review | [ADR index/template](../adr/README.md), [architecture view](../architecture/README.md), [IaC responsibilities](../../deploy/README.md) and [review template](sprint-review-template.md) are in [PR #27](https://github.com/krispykrits/TRACE/pull/27) for review. The demonstration and open decision register are below. | Owner review is pending; no AWS resource is provisioned by this issue. |
