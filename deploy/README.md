...
S7 chooses exact topology and Terraform state/access; S8 chooses application artifact release and rollback and configures CloudWatch Logs collection on the EC2 target; S9 verifies hosted delivery, retention, rotation and collector recovery as part of Cloud MVP acceptance. Until then, use the [local development workflow](../docs/development.md). Neither a plan file nor these documents prove hosted logging delivery or Cloud MVP acceptance.
